...
for file in root.tk.splitlist(files): # This loop goes through every pdf file which were selected in the file dialog
    ...
    png_files = convert_from_path(file, dpi=300, poppler_path=r'C:\Users\windows\Desktop\poppler-0.68.0\bin') # Get the path of every file and safe it in a variable
